...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    app.send_message(message.chat.id, f"__👋 Hi **{message.from_user.mention}**, i am Link Bypasser Bot made by godofhell, just send me any supported links and i will you get you results.\nCheckout /help to Read More__",
    reply_markup=InlineKeyboardMarkup([
        [ InlineKeyboardButton("🌐 Main Channel", url="https://t.me/course_by_godofhell")],
        [ InlineKeyboardButton("Bots Update", url="https://t.me/coursebygodofhell_bots") ]]), 
